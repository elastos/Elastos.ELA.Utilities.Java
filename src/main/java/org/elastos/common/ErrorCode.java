...
public class ErrorCode {
    ...
    public static String INVALID_AMOUNT = getError(51016, "amount can not be positive integer");
    ...
    public static String INVAL_FEE = getError(52002, "invalid fee");
    public static String FEE_NOT_NULL = getError(52003, "fee can not be empty");
    public static String INVAL_CONFIRMATION = getError(52004, "invalid confirmation");
