...
public class UtilTest {
    ...
    public void writeVarUint() throws Exception {
        ...
        System.out.println(DatatypeConverter.printHexBinary(baos.toByteArray()));
        assertEquals("FE0000000001000000",DatatypeConverter.printHexBinary(baos.toByteArray()));
        baos.reset();

        Util.WriteVarUint(dos,9223372036854775807L);
        System.out.println(DatatypeConverter.printHexBinary(baos.toByteArray()));
        assertEquals("FEFFFFFFFFFFFFFF7F",DatatypeConverter.printHexBinary(baos.toByteArray()));
        baos.reset();
